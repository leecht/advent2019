    ...
    public static void main(String args[]) {
        ...
        for (int nTest = nPasswordStart; nTest <= nPasswordEnd; nTest++) {
            ...
            if (strPair1.startsWith(strPair1.substring(1))) {
                // Matched Pair
                strFind = strPair1.concat(strPair1.substring(1));
                if (strTest.contains(strFind)) {
                    // Matched Pair is part of larger group
//                    bContinue = false;
                } else {
                    // Matched Pair is isolated
                    bContinue = true;
                }
            }
            if (strPair2.startsWith(strPair2.substring(1))) {
                // Matched Pair
                strFind = strPair2.concat(strPair2.substring(1));
                if (strTest.contains(strFind)) {
                    // Matched Pair is part of larger group
//                    bContinue = false;
                } else {
            ...
            if (strPair3.startsWith(strPair3.substring(1))) {
                // Matched Pair
                strFind = strPair3.concat(strPair3.substring(1));
                if (strTest.contains(strFind)) {
                    // Matched Pair is part of larger group
//                    bContinue = false;
                } else {
            ...
            if (strPair4.startsWith(strPair4.substring(1))) {
                // Matched Pair
                strFind = strPair4.concat(strPair4.substring(1));
                if (strTest.contains(strFind)) {
                    // Matched Pair is part of larger group
//                    bContinue = false;
                } else {
            ...
            if (strPair5.startsWith(strPair5.substring(1))) {
                // Matched Pair
                strFind = strPair5.concat(strPair5.substring(1));
                if (strTest.contains(strFind)) {
                    // Matched Pair is part of larger group
//                    bContinue = false;
                } else {
